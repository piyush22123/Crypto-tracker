    ...
    <div className= {`grid-container ${
      coin.price_change_percentage_24h < 0 && "grid-container-red"
        ...
        {coin.price_change_percentage_24h > 0 ? (
          ...
          <div className="red-icon-chip"><TrendingDownIcon/></div>
        </div>
        )}
        ...
        <div className="info-container">
          <h3 className='coin-price'>Rs {coin.current_price.toLocaleString()}</h3>
        </div>
        ) : (
          <div className="info-container">
          <h3 className='red-price'>Rs {coin.current_price.toLocaleString()}</h3>
        </div>
        )}
